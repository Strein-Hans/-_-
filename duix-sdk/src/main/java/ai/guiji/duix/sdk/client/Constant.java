...
public class Constant {
    ...
    public static final String AVATAR_MODEL_URL = "https://gh-proxy.com/https://github.com/duixcom/Duix-Mobile/releases/download/v2.0.1/Lily.zip"; // 数字人形象模型包（女性，gh-proxy国内加速）
