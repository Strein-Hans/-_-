# Svatar — AI 雅思口语陪练数字人应用

> Demo 展示：http://xhslink.com/o/66485xXNeGR
> 先复制文字，然后进入【小红书】查看笔记。

## 功能特性

- 🤖 **AI 考官对话** — DeepSeek 大模型驱动的雅思口语对话
- 🎭 **数字人交互** — DUIX SDK 端侧渲染，唇形实时同步
- 💡 **情感检测** — 实时识别 7 种情绪状态（自信/紧张/热情/迟疑/挫败/平静/中性）
- 🔄 **跑题引导** — 考生偏离话题时自然引导回归
- 📊 **智能评分** — 四维评分（流利度/词汇/语法/发音）+ 个性化改进建议
- ⏱️ **对话时序优化** — 模拟真实考官思考停顿和过渡节奏
